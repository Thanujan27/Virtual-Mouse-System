...
def main(cap_device, mode, kando):
    ...
    window_name = 'Virtual Mouse Controller'
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            if enable_access == 1:
                if i == 0:
                    preX = hand_landmarks.landmark[0].x
                    preY = hand_landmarks.landmark[0].y
                    i += 1
        ...
        cv2.putText(image, "FPS:"+fps, (20, 80),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 3)
        dst = cv2.resize(image, dsize=None, fx=0.8,
                         fy=0.8)         
